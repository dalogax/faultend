  ...
  async loadCollaborators(isOwner = false) {
    ...
    try {
      ...
      container.innerHTML = result.collaborators.map(c => {
        ...
        const roleBadgeClass = isCollabOwner ? 'owner' : c.role === 'admin' ? 'admin' : 'collaborator';
        ...
        return `
          <div class="collab-row">
            <div class="collab-id">
              ...
              <span class="badge badge-role-${escapeHtml(roleBadgeClass)}">${escapeHtml(roleLabel)}</span>
            </div>
